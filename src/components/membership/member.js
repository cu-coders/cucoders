...
export default ({ isLoggedIn ,cards = null, heading = "Why Join Us", subheading = "Membership", description = "You are not a product of your circumstances. You are a product of your decisions." }) => {
  /*
