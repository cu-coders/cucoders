      ...
      <Content>
        <Row>
          ...
          <LinksContainer>
            ...
            <Link href="http://status.cuchapter.tech/" target="_blank">
              Status
            </Link>
            <Link href="http://api.cuchapter.tech/" target="_blank">
              APIs
            </Link>
          </LinksContainer>
          ...
          <CopyrightText>
            &copy; Copyright 2019 - {showCurrentYear}, CU-Coders. All Rights
            Reserved.
          </CopyrightText>
        </Row>
      </Content>
