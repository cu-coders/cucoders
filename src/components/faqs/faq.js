...
} from "feather-icons/dist/icons/chevron-down.svg";
import {motion} from "framer-motion";
import {
  ReactComponent as SvgDecoratorBlob1
} from "images/svg-decorator-blob-7.svg";
import {
  ReactComponent as SvgDecoratorBlob2
} from "images/svg-decorator-blob-8.svg";
...
const FAQ =
    tw.div`cursor-pointer select-none mt-5 px-8 sm:px-10 py-5 sm:py-4 rounded-lg text-gray-800 hover:text-gray-900 bg-gray-200 hover:bg-gray-300 transition duration-300`;
...
export default ({
  ...
  faqs =
      [
        ...
        {
          question :
              "What are the criteria of community membership & official membership?",
          answer :
        ...
        },
        {
          ...
          answer :
              "You can contact us on our offical e-mail ID - 'admin@cuchapter.tech' or on our Instagram account."
        }
      ]
}) => {
