              ...
              <Testimonial key={index}>
                <QuoteContainer>
                  ...
                  <Quote>
                    {testimonial1.quote}
                    <ul>
                      1. Proficient with Adobe Photoshop, Illustrator, Premiere,
                      and After Effects.
                    </ul>
                    <ul>
                      2. Proficient in motion graphic animation techniques.
                    </ul>
                    <ul>
                      3. Willingness to be a part of multiple projects
                      simultaneously.
                    </ul>
                    <ul>
                      4. Knowledge of 2D/3D, stop motion and computer-generated
                      animation
                    </ul>
                  </Quote>
                </QuoteContainer>
              ...
              <Testimonial key={index}>
                <QuoteContainer>
                  ...
                  <Quote>
                    {testimonial.quote}
                    <ul>
                      1. Read scripts and storylines to understand animation
                      requirements.
                    </ul>
                    <ul>
                      2. Prepare presentations with raw designs to customers.
                    </ul>
                    <ul>
                      3. Develop storyboards for the initial stages of
                      production.
                    </ul>
                    <ul>
                      4. Create models, drawings and illustrations by hand or
                      electronically
                    </ul>
                    <ul>
                      5. Join images with background graphics and special
                      effects.
                    </ul>
              ...
              <Testimonial key={index}>
                <QuoteContainer>
                  ...
                  <Quote>
                    {testimonial.quote}
                    <ul>
                      1. Willingness to be a part of multiple projects
                      simultaneously.
                    </ul>
                    <ul>
                      2. Collaborate with design, animation, and visual effects
                      departments to meet the highest visual quality
                    </ul>
                  </Quote>
                </QuoteContainer>
              </Testimonial>
