...
export default ({
  ...
  with product managers and engineers.<
      ...
      <ul>3. Design graphic user interface elements,
      like menus,
      tabs and widgets.<
          /ul>
                    <ul>4. Build page navigation buttons and search fields.</ul>
      <ul>5. Develop UI mockups and prototypes that clearly
  illustrate how sites function and look like.<
      ...
      <ul>7. Prepare and present rough drafts to internal teams and
  key stakeholders
      .</ul>
                    <ul>
      ...
      <ul>9. Conduct layout adjustments based on user feedback
      .</ul>
                    <ul>
