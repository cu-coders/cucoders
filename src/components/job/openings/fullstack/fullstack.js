  ...
  return (
    <>
      <AnimationRevealPage>
              ...
              <Testimonial key={index}>
                <QuoteContainer>
                  ...
                  <Quote>
                    {testimonial1.quote}
                    <ul>
                      1. At least three months’ experience with:
                      <li>
                        Writing HTML, CSS, and JavaScript. Being up on latest
                        practices is a must.
                      </li>
                      <ol>A relevant back-end programming language. </ol>
                      <ol>
                        Database design and management, including being up on
                        the latest practices and associated versions
                      </ol>
                      <ol>
                    ...
                    <ul>
                      2. Familiarity with a relevant and globally supported
                      framework—both front-end and back-end, if necessary.
                    </ul>
                    <ul>
                      3. Ideally, familiarity with CSS preprocessors, bundlers,
                      and associated languages/syntaxes/libraries.
                    </ul>
                    <ul>
                      4. Thorough understanding of user experience and possibly
                      even product strategy.
                    </ul>
                    <ul>
                      5. Experience implementing testing platforms and unit
                      tests.
                    </ul>
              ...
              <Testimonial key={index}>
                <QuoteContainer>
                  ...
                  <Quote>
                    {testimonial.quote}
                    <ul>
                      1. Design and implementation of the overall web
                      architecture.
                    </ul>
                    <ul>
                      2. “Pixel-perfect” implementation of our approved user
                      interface.
                    </ul>
                    <ul>3. Design and deployment of our database.</ul>
                    <ul>
                      4. Ensuring the entire stack is designed and built for
                      speed and scalability.
                    </ul>
                    <ul>5. Design and construction of our REST API.</ul>
                    <ul>
                      6. Integrating our front-end UI with the constructed API.
                    </ul>
                    <ul>
                      7. Design and implementation of continuous integration and
                      deployment.
                    </ul>
                  </Quote>
                </QuoteContainer>
              ...
              <Testimonial key={index}>
                <QuoteContainer>
                  ...
                  <Quote>
                    ...
                    <ul>
                      2. A basic understanding of design and development
                      principles.
                    </ul>
                  </Quote>
                </QuoteContainer>
        ...
        <Apply role={"fullstack-developer"} />
        <Footer />
      </AnimationRevealPage>
    </>
  );
