              ...
              <Testimonial key={index}>
                <QuoteContainer>
                  ...
                  <Quote>
                    {testimonial1.quote}
                    <ul>
                      1. Have proficiency in using Adobe products like InDesign,
                      Illustrator, and Photoshop.
                    </ul>
                    <ul>
                      2. A basic working knowledge of screen design tools like
                      Canva, Sketch.
                    </ul>
                    <ul>
                      3. Excellent communication skills, including the ability
                      to clearly explain design decisions in words and writing.
                    </ul>
                    <ul>
                      4. The ability to receive, interpret, and implement
                      constructive feedback from project stakeholders into your
                      design work.
                    </ul>
                    <ul>
                      5. An appreciation for and awareness of emerging design
                      trends in print and digital.
                    </ul>
                    <ul>
                      6. Able to learn new tools and processes quickly and work
              ...
              <Testimonial key={index}>
                <QuoteContainer>
                  ...
                  <Quote>
                    {testimonial.quote}
                    <ul>
                      1. Design pages for print and digital so that information
                      is easy to find, read, and understand.
                    </ul>
                    <ul>
                      2. Gather all relevant facts for each project and ensure
                      that all deliverables communicate the correct information.
                    </ul>
                    <ul>
                      3. Generate clear ideas, concepts, and designs of creative
                      assets from beginning to end.
                    </ul>
                    <ul>
                      4. Work collaboratively with other designers to ensure a
                      consistent, integrated brand perception.
                    </ul>
                    <ul>
                      5. Collaborate with a cross-functional team that includes
                      marketers, creative directors, and product managers in
                      order to create compelling designs.
                    </ul>
                    <ul>
                      6. Stay on top of the latest standards, processes, and
                      trends in the visual design field.
                    </ul>
                  </Quote>
                </QuoteContainer>
              </Testimonial>
              ...
              <Testimonial key={index}>
                <QuoteContainer>
                  ...
                  <Quote>
                    ...
                    <ul>
                      2. A strong portfolio that showcases aesthetic awareness
                      and design problem solving abilities..
                    </ul>
